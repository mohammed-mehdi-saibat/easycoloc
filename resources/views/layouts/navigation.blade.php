        ...
        <div class="flex justify-between h-24">
            <div class="flex items-center">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="text-2xl font-black tracking-tighter text-slate-950 uppercase italic">
                        Easy<span class="text-emerald-600">Coloc</span>
                    </a>
                </div>
